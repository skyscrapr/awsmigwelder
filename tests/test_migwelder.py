import pytest
from migwelder import is_covered, consolidate_rules, write_rules_to_csv, read_rules_from_csv

sample_rules = [
    {"Type": "ingress", "IpProtocol": "tcp", "FromPort": "80", "ToPort": "80", "CidrIp": "10.0.0.0/24", "Description": "HTTP"},
    {"Type": "ingress", "IpProtocol": "tcp", "FromPort": "80", "ToPort": "80", "CidrIp": "10.0.0.10/32", "Description": "Specific Host"},
    {"Type": "egress", "IpProtocol": "-1", "FromPort": "", "ToPort": "", "CidrIp": "0.0.0.0/0", "Description": "All outbound"}
]
